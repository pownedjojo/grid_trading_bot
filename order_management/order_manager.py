...
class OrderManager:
    def __init__(self, config_manager):
        ...
        self.trade_percentage = 0.1 ## TODO: trade_percentage should be in config.json
        self.grid_levels = {}
    ...
    def execute_order(self, order_type: OrderType, current_price, previous_price, timestamp, balance, crypto_balance):
        grid_level_crossed = self._detect_grid_level_crossing(current_price, previous_price, sell=(order_type == OrderType.SELL))
    ...
    def _detect_grid_level_crossing(self, current_price, previous_price, sell=False):
    ...
    def _process_sell_order(self, grid_level, current_price, timestamp, balance, crypto_balance):
        try:
            buy_grid_level = self._find_lowest_completed_buy_order_grid_level()
            ...
            self._check_sufficient_crypto(crypto_balance, quantity, grid_level.price)
    ...
    def _find_lowest_completed_buy_order_grid_level(self):
    ...
    def _check_sufficient_crypto(self, crypto_balance, quantity, grid_price):
