...
class TransactionValidator:
    ...
    def validate_buy_order(self, balance: float, quantity: float, price: float, grid_level: GridLevel) -> None:
        self._check_balance(balance, quantity, price, grid_level)
        self._check_grid_level(grid_level, is_buy=True)

    def validate_sell_order(self, crypto_balance: float, quantity: float, grid_level: GridLevel) -> None:
        self._check_crypto_balance(crypto_balance, quantity, grid_level)
        self._check_grid_level(grid_level, is_buy=False)

    def _check_balance(self, balance: float, quantity: float, price: float, grid_level: GridLevel) -> None:
    ...
    def _check_crypto_balance(self, crypto_balance: float, quantity: float, grid_level: GridLevel) -> None:
    ...
    def _check_grid_level(self, grid_level: GridLevel, is_buy: bool = True) -> None:
